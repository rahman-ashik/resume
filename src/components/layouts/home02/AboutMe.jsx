...
class AboutMe extends React.Component {
    ...
    render() {
        return (
          <>
            <div class="p-4 flex flex-wrap justify-evenly justify-items-center justify-self-center content-evenly align-items-center align-self-center place-content-evenly place-items-center place-self-center">
              ...
              <div>
                <p class="text-center text-xxl text-gray-500 dark:text-gray-400 max-w py-4 font-light">
